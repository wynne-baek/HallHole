...
public interface CommentService {
    ...
    List<Comment> CommentListfindByMemberId(CommentFindByMemberIdDTO inputDTO) throws NotFoundException;

    List<Comment> CommentListfindByReviewId(CommentFindByReviewIdDTO inputDTO) throws NotFoundException;
}
