...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.httpBasic().disable().authorizeRequests() // 요청에 대한 사용권한 체크
                ...
                .addFilterBefore(new JwtAuthenticationFilter(jwtTokenProviderImpl),
...
//                .and()
//                .authorizeRequests()
//                .antMatchers("/member/join","/member/login","/member/reissue","/index.html","/index_bundle.js").permitAll()
